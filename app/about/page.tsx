...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about Geneomm Medical Center, our mission, vision, and commitment to providing hope through advanced genetic diagnosis and rare disease management.',
};
