  ...
  return (
    <Section title="Meet Our Medical Team" subtitle="EXPERTS IN GENETIC MEDICINE" className="bg-white overflow-hidden">
          ...
          >
            <div className="relative overflow-hidden rounded-lg mb-4 shadow-lg">
              <Image 
                ...
                width={400}
                height={500}
                className="w-full h-80 sm:h-96 object-cover rounded-lg transform group-hover:scale-110 transition-transform duration-500" 
              />
      ...
      <div className="text-center mt-12">
        <Link href="/consultants" className="bg-primary text-white px-8 py-3 rounded-full text-base font-semibold hover:bg-opacity-90 transition-all inline-block">
