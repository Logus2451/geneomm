...
export const services = [
  ...
  },
  {
    ...
    details: {
      ...
      whatToExpect: "A comprehensive consultation including physical examination, review of records, and discussion of potential genetic testing to establish a diagnosis and create a management plan.",
      faqs: [
